...
- Re-create the CLDF dataset:
  ```shell
  cldfbench makecldf --glottolog-version v5.2 cldfbench_lee_and_hasegawa2011.py --with-zenodo --with-cldfreadme
  ```
...
- Re-create the README:
  ```shell
  cldfbench readme cldfbench_lee_and_hasegawa2011.py
  ```
- Run Phlorest-specific checks on the data:
  ```shell
  phlorest check --with-R cldfbench_lee_and_hasegawa2011.py
  ```
...
- Create the release instruction:
  ```shell
  phlorest release cldfbench_lee_and_hasegawa2011.py vX.Y
  ```
